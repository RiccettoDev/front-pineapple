  ...
  function coppyId() {
    if (user?.id) {
      navigator.clipboard.writeText(user.id)
        .then(() => {
          console.log("ID copiado para a área de transferência:", user.id);
          // Aqui você pode adicionar uma notificação ou mensagem de sucesso, se desejar
          toast({
        ...
        .catch((error) => {
          ...
          // Aqui você pode adicionar uma notificação ou mensagem de erro, se desejar
          toast({
            title: "Erro ao copiar ID para a área de transferência!",
            status: "error",
            duration: 3000,
            isClosable: true,
            position: "top"
      ...
      // Aqui você pode adicionar uma notificação ou mensagem de erro, se desejar
      toast({
        title: "ID do usuário não disponível.",
        status: "error",
        duration: 3000,
        isClosable: true,
        position: "top"
